...
cxx_flags = MakefileVariable("CXXFLAGS", "-I/home/jwzeng/tools/csmith/include")
Makefile_variable_list.append(cxx_flags)

# ! yarpgen or csmith
# ld_flags = MakefileVariable("LDFLAGS", "")
ld_flags = MakefileVariable("LDFLAGS", "-ldl -lm")
...
def detect_native_arch():
    ...
    if ret_code != 0:
        print('sys_compiler: ', sys_compiler)
